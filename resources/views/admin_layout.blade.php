            ...
            <ul class="sidebar-menu" id="nav-accordion">
                ...
                <li class="sub-menu">
                 ...
                 <li class="sub-menu">
                    ...
                    <ul class="sub">
                        <li><a href="{{URL::to('/delivery')}}">Tính cước vận chuyển</a></li>
                ...
                <li class="sub-menu">
                 ...
                 <li class="sub-menu">
                    ...
                    <ul class="sub">
                         <li><a href="{{URL::to('/add-users')}}">Thêm tài khoản nhân viên</a></li>
                 ...
                 <li class="sub-menu">
                    ...
                    <ul class="sub">
                        ...
                        <li><a href="{{URL::to('/customer')}}">Danh sách tài khoản</a></li>
 ...
 <!-- footer -->
		  <div class="footer">
			<div class="wthree-copyright">
			  <p>Thông tin liên hệ của mình <a target="_blank" href="https://www.facebook.com/hungduyen.30050301">ở đây nhé</a></p>
			</div>
		  </div>
  <!-- / footer -->
</section>
